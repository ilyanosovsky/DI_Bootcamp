...
// the sound the animal makes, and returns the details of the animal (name, type and color) 
...
class Mamal extends Animal{
    ...
    sound () {
        const noiseSound = `${this.noise} I'm a ${this.typeA} named ${this.nameA} and I'm  ${this.colorA} color`;
        console.log(noiseSound);
    }
}

const animalOne = new Mamal("Lily", "cow", "brown", "Mooooooo");
animalOne.sound();
