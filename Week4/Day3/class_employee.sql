...
-- (
--    DEPTCODE   INTEGER NOT NULL DEFAULT nextval('dep_id_seq') PRIMARY KEY,
--    DeptName   CHAR(30),
...
-- SELECT empfname, emplname, job, location FROM employee
-- INNER JOIN department ON deptcode = department_code
